...
int main()
{
	...
	while (sentinel)
	{
		...
		cout << endl
				 << "If you want to start, type \"1\", otherwise, type \"0\" and press enter: ";
		cin >> input;
			...
			while (k == 0)
			{
				...
				while (d == 0)
				{
					if (k == 0)
					{
						...
						{
							cout << endl
									 << "No se encontro una solucion. Se colocaron " << l << " Reinas" << endl;
							cout << setw(86) << endl
									 << endl
									 << "Intento numero " << attempt << endl;
							d = 0;
							attempt++;
							EmptyTable(Table);
						}
						else if (k == true)
						{
							attempt--;
							cout << endl
									 << setw(100) << "*A solution was found in attempt number " << attempt << "*" << endl
									 << endl;
							printFinal(Table, Y, X, size);
							d = 1;
							attempt = 2;
							cout << endl
									 << setw(87) << "Fin de la ejecucion" << endl
									 << endl;
						}
					}
	...
	cout << endl
			 << endl
			 << setw(88) << "End of the 8 Queens Problems." << endl
			 << endl;
...
{
	// Instructions
	cout << setw(87) << "The 8 queens: " << endl
			 << endl
