...
public class DoublyLinkedList<E> {
    ...
    private static class Node<E> {
        ...
        public Node(E el, Node<E> prev, Node<E> next) {
            this.element = el;
            this.prev = prev;
            this.next = next;
        }
    ...
    public int hashCode() {
        int hash = 5;
        hash = 15 * hash + Objects.hashCode(this.header);
        hash = 15 * hash + this.size;
        hash = 15 * hash + Objects.hashCode(this.trailer);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(this.trailer, other.trailer);
    }
