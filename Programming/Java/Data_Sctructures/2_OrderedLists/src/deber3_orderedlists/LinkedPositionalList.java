...
public class LinkedPositionalList<E> implements PositionalList<E> {
    ...
    public void forEach(Consumer<? super E> action) {
        PositionalList.super.forEach(action); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public Spliterator<E> spliterator() {
        return PositionalList.super.spliterator(); //To change body of generated methods, choose Tools | Templates.
    }
  //---------------- nested Node class ----------------
  /**
