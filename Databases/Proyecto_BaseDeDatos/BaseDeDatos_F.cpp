...
int main(){
	...
	for(int i = 0; i < 2; i++){
		...
		<< "\nCodigo: " << cantidadC.getComida(i).getCodigo();
	}*/
	cout << endl << "        Nombre     Apellido     Direccion     Numero"
	<< endl << endl << "      Alejandro     Maruri       Ofelia      0999055068" << endl
	<< setw(5) << "        Teresa     Tinajero      Tumbaco     0984559221" << endl << endl;
	
	cout << endl << endl << endl << "        Nombre     Valor/Unitario     Valor/Docena     Valor/Centena     Codigo"
	<< endl << endl <<"       Lassagna         5                  55               450           12345" << endl
	<<                "       Ceviche         3.5                 40              34.50          34562"
	<< endl << endl;
