...
public class TicTacToeBoard {
     ...
     * @param playerSymbol The String symbol of the player who now has the
     * square.
    ...
    public void cleanSquare(int row, int col){
        if(!square[row][col].equals(BLANK)){
            this.numEmptySquares++;
        }
        square[row][col] = BLANK;
    }
    /**
     * The method to use when needing to update the game board's state.
     *
     * @param row The row of the square to update.
     * @param col The column of the square to update.
     * @param playerIndex The integer index of the player who now has the
     * square.
    ...
    /**
     * Returns the contents of a square where the contents are the constants X,
     * O, or BLANK
     *
     * @param row The row of the square
     * @param col The col of the square
     * @return The contents of the square where the contents are the constants
     * X, O, or BLANK
     */
    ...
    /**
     * Returns the index of the player who owns the square. The player index can
     * be PLAYER_X, PLAYER_O, or PLAYER_NONE.
     *
     * @param row The row of the square
     * @param col The col of the square
     ...
     *
     * @param player The player who will have the next turn.
     */
     ...
     *
     * @return True if a player wins the game and false if the game is a draw or
     ...
     * @return True if there is a vertical 3-in-a-row for the specified player
     * and false otherwise.
     * @throws Exception If the player index is invalid.
     */
     ...
     *
     * @param player The player index
     * @return True if there is a horizontal 3-in-a-row for the specified player
     * and false otherwise.
     * @throws Exception If the player index is invalid.
     */
     ...
     *
     * @param player The player index
     * @return True if there is a diagonal 3-in-a-row pattern for the specified
