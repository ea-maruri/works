...
/**
 * This class is used to manage the JPanel that will contain the X's and O's. It
 * is also used to trap the mouse event and determine which cell/grid to update.
 *
...
public class CustomPanel extends JPanel {
    ...
    /**
     * This is a flag denoting if a player has already chosen this cell/grid.
     */
    private boolean chosen;

    /**
     * Reference to the player objects to signal the human classes (if there are
     * human players) that a cell/grid was chosen.
     */
    private Player player1, player2;

    /**
     * Reference to the state class so the JPanel is aware of whose turn it is.
     */
    private TicTacToeBoard turnState;

    /**
     * Constructor used to initialize all of the JPanels state information, and
     * add the mouseClicked event handler.
     *
