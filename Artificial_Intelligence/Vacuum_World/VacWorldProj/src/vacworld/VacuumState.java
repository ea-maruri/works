...
public class VacuumState extends State {
    ...
    /**
     * @param randSeed
     * @return Return a random initial state for the vacuum world using a 
     * specific seed. The agent's initial location, dirt locations and other 
    ...
    /**
     * @return Return the agent's orientation. Note that the constants in the Direction
